...
#define DEBUG true 
SoftwareSerial esp8266(9,10); //this allows Arduino to use ESP8266 to send data to the IP
...
//References:
// Circuit Digest => https://circuitdigest.com/microcontroller-projects/iot-heartbeat-monitoring-using-arduino
